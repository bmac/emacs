...
(when (display-graphic-p)
  ...
  (setq prelude-packages '(cl-lib browse-kill-ring exec-path-from-shell find-file-in-repository git-gutter-fringe magit js2-mode solarized-theme jedi markdown-mode prodigy stylus-mode rust-mode neotree))
