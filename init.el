...
(when (display-graphic-p)
  ...
  (setq prelude-packages '(cl-lib browse-kill-ring exec-path-from-shell find-file-in-repository git-gutter-fringe less-css-mode magit js2-mode solarized-theme jedi markdown-mode))
